                ...
                <div class="col-lg-8 col-sm-12 ">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 ">
                            <a href="blogdetail.php" class="thumbnail"><img src="images/blog/4.jpg" alt="blog title"></a>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 ">
                          <a href="blogdetail.php" class="thumbnail"><img src="images/blog/2.jpg" alt="blog title"></a>
                        </div>
                        <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.php">Creative business to takeover the market</a></h3>
                            <div class="info">Posted on: Jan 20, 2013</div>                                               
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 ">
                          <a href="blogdetail.php" class="thumbnail"><img src="images/blog/1.jpg" alt="blog title"></a>
                        </div>
                        <div class="col-lg-8 col-sm-8 ">
                            <h3><a href="blogdetail.php">Creative business to takeover the market</a></h3>
                            <div class="info">Posted on: Jan 20, 2013</div>                                               
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 ">
                          <a href="blogdetail.php" class="thumbnail"><img src="images/blog/3.jpg" alt="blog title"></a>
                        </div>
                        <div class="col-lg-8 col-sm-8 ">
                        <h3><a href="blogdetail.php">Creative business to takeover the market</a></h3>
                        <div class="info">Posted on: Jan 20, 2013</div>                                               
