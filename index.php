                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-4">
                          <select class="form-control">
                            ...
                            <option>Rp.1.100,000 - Rp.5.000,000</option>
                            <option>Rp.5.100,000 - Rp.10.000,000</option>
                            <option>Rp.10.100,000 - above</option>
                          </select>
                        </div>
                        <div class="col-lg-3 col-sm-4">
                          <select class="form-control">
                        ...
                        <div class="col-lg-3 col-sm-4">
                          <button class="btn btn-success"  onclick="window.location.href='allproducts.php'">Find Now</button>
                        </div>
                    </div>
                  </div>
              </div>
...
<section>
  <div class="container">
    <div class="products-listing spacer"> <a href="promo.php" class="pull-right viewall">View All Listing</a>
